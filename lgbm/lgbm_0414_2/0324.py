...
# 只保留這些欄位
X_test_aligned_for_imputer = X_test_numeric.reindex(columns=imputer_features)

# Imputer 處理
X_test_imputed = imputer.transform(X_test_aligned_for_imputer)

# 轉回 DataFrame
X_test_df = pd.DataFrame(X_test_imputed, columns=imputer_features)
